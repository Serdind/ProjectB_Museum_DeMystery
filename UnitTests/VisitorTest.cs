...
namespace UnitTests
{
    ...
    public class VisitorTests
    {
        ...
        [TestMethod]
        public void RebookReservationTest()
        {
            // Arrange
            FakeMuseum museum = new FakeMuseum();
            Program.Museum = museum;
            ...
            Visitor visitor = new Visitor(0, "123456");
            ...
            // Act
            ProgramController.RebookReservation(visitor);

            // Assert
            var tours = JsonConvert.DeserializeObject<List<GuidedTour>>(museum.Files[filePathTours]);
            var tour1 = tours.FirstOrDefault(t => t.ID == 1);
            ...
            if (tour1 != null) // Added null check for tour1
            {
                ...
                {
                    Debug.WriteLine(v.QR);
                }
            }
            else
            {
                Debug.WriteLine("Tour 1 is null");
            }

            Debug.WriteLine("Tour 2 Reserved Visitors:");
            if (tour2 != null) 
            {
                foreach (var v in tour2.ReservedVisitors)
                {
                    Debug.WriteLine(v.QR);
                }
            }
            ...
            {
                Debug.WriteLine("Tour 2 is null");
            }

            Debug.WriteLine("Lines Written:");
            foreach (var line in museum.LinesWritten)
            {
            ...
            var expectedSuccessMessage = $"Reservation successful. You have reserved the following tour:\n" +
                                         ...
                                         $"Duration: 40 minutes\n" +
                                         $"Language: {tour2.Language}\n" +
                                         $"Name of guide: {tour2.NameGuide}\n";
